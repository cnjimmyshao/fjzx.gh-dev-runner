...
- [2026-09-23 本机 Harness 会话创建、续接与原 Web 界面观察验证](2026-09-23-local-harness-session-handoff.md)——常驻 Harness 的会话创建、同会话续接和原 Web 界面可视化已在本机闭环验证（Issue #3）；引导方式（一次性人工引导／自动抓取／另造凭据）仍需维护者决定。
